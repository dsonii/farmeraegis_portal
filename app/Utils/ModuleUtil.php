...
class ModuleUtil extends Util
{
    ...
    public function availableModules()
    {
        return [
            ...
            'assign_raw_materials' => ['name' => __('assignment.assign_raw_materials')],
            'demands' => ['name' => __('demand.order')],
            'pending' => ['name' => __('lang_v1.pending')],
            'completed' => ['name' => __('lang_v1.completed')],
