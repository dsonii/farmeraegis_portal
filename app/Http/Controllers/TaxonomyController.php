...
class TaxonomyController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $input = $request->only(['name', 'short_code', 'category_type', 'description', 'photo', 'icon', 'status']);
            ...
            $input['photo'] = $this->productUtil->uploadFile($request, 'photo', config('constants.category_img_path'), 'image');
            $input['icon'] = $this->productUtil->uploadFile($request, 'icon', config('constants.category_icon_path'), 'image');
    ...
    public function update(Request $request, $id)
    {
        ...
        if (request()->ajax()) {
            try {
                ...
                $category->photo = $this->productUtil->uploadFile($request, 'image', config('constants.category_img_path'), 'image');
                $category->icon = $this->productUtil->uploadFile($request, 'image', config('constants.category_icon_path'), 'image');
                // $category->photo = '';
                // $category->icon = '';
