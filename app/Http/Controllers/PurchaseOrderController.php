...
class PurchaseOrderController extends Controller
{
    ...
    public function pending()
    {
        ...
        return view('purchase_order.pending')->with(compact('business_locations', 'suppliers', 'purchaseOrderStatuses', 'shipping_statuses'));
    }
    ...
    public function completed()
    {
        ...
        return view('purchase_order.completed')->with(compact('business_locations', 'suppliers', 'purchaseOrderStatuses', 'shipping_statuses'));
    }
    ...
    public function getPurchaseOrdersPo(Request $request)
    {
        $business_id = request()->session()->get('user.business_id');
