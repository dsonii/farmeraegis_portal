<div class="pos-tab-content">
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                {!! Form::label('referral_amount', __('Referral Amount') . ':') !!}
                {!! Form::text('common_settings[referral_amount]', !empty($common_settings['referral_amount']) ? $common_settings['referral_amount'] : null, ['class' => 'form-control','placeholder' => __('Referral Amount'), 'id' => 'referral_amount']); !!}
            </div>
        </div>
    </div>
</div>