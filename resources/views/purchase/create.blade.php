...
<section class="content">
	...
	@component('components.widget', ['class' => 'box-primary'])
		...
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="form-group">
					{!! Form::label('supplier_invoice_number', __('lang_v1.supplier_invoice_number').':') !!}
					{!! Form::text('supplier_invoice_number', null, ['class' => 'form-control', 'id' => 'supplier_invoice_number']); !!}
				</div>
			</div>
			<div class="col-sm-3">
				<div class="form-group">
			...
			<div class="col-sm-3">
				<div class="form-group">
					{!! Form::label('supplier_invoice_date', __('lang_v1.supplier_invoice_date').':') !!}
					{!! Form::date('supplier_invoice_date', null, ['class' => 'form-control', 'id' => 'supplier_invoice_date']); !!}
				</div>
			</div>
		</div>
		@endif
