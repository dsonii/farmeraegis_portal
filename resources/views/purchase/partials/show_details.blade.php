  ...
  <div class="row invoice-info">
    ...
    <div class="col-sm-4 invoice-col">
      ...
      @if(!empty($purchase_order_nos))
        ...
        @endif
        @if(!empty($purchase->supplier_invoice_number))
            <br>
            <strong>@lang('lang_v1.supplier_invoice_number'):</strong>
            {{$purchase->supplier_invoice_number}}
        @endif
        @if(!empty($purchase->vehicle_number))
            <br>
            <strong>@lang('lang_v1.vehicle_number'):</strong>
            {{$purchase->vehicle_number}}
        @endif
        @if(!empty($purchase->supplier_invoice_date))
            <br>
            <strong>@lang('lang_v1.supplier_invoice_date'):</strong>
