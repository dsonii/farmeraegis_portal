@extends('layouts.app')
@section('title', __('demand.add_demand'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>@lang('demand.add_demand') <i class="fa fa-keyboard-o hover-q text-muted" aria-hidden="true" data-container="body" data-toggle="popover" data-placement="bottom" data-content="@include('demand.partials.keyboard_shortcuts_details')" data-html="true" data-trigger="hover" data-original-title="" title=""></i></h1>
</section>
...
<section class="content">
	...
	{!! Form::open(['url' => action('DemandController@store'), 'method' => 'post', 'id' => 'add_demand_form', 'files' => true ]) !!}
	@component('components.widget', ['class' => 'box-primary'])
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="form-group">
					{!! Form::label('supplier_id', __('demand.supplier') . ':*') !!}
			...
			<div class="@if(!empty($default_demand_status)) col-sm-4 @else col-sm-3 @endif">
				<div class="form-group">
					{!! Form::label('transaction_date', __('demand.demand_date') . ':*') !!}
					<div class="input-group">
						<span class="input-group-addon">
			...
			<div class="col-sm-3 @if(!empty($default_demand_status)) hide @endif">
				<div class="form-group">
					{!! Form::label('status', __('demand.demand_status') . ':*') !!} @show_tooltip(__('tooltip.order_status'))
					{!! Form::select('status', $orderStatuses, $default_demand_status, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select'), 'required']); !!}
				</div>
			</div>			

			<!-- Currency Exchange Rate -->
			<div class="col-sm-3 @if(!$currency_details->demand_in_diff_currency) hide @endif">
				<div class="form-group">
					{!! Form::label('exchange_rate', __('demand.p_exchange_rate') . ':*') !!}
					...
					<span class="help-block text-danger">
						@lang('demand.diff_demand_currency_help', ['currency' => $currency_details->name])
					</span>
				</div>
			</div>
			...
			<div class="col-sm-3">
                <div class="form-group">
                    {!! Form::label('document', __('demand.attach_document') . ':') !!}
                    {!! Form::file('document', ['id' => 'upload_document', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types')))]); !!}
                    <p class="help-block">
                    	@lang('demand.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)])
		...
		<div class="row">
			...
			<table class="table">
				<tr>
					<td class="col-md-3">
						<div class="form-group">
							{!! Form::label('discount_type', __( 'demand.discount_type' ) . ':') !!}
					...
					<td class="col-md-3">
						<div class="form-group">
						{!! Form::label('discount_amount', __( 'demand.discount_amount' ) . ':') !!}
				...
				<tr>
					<td>
						<div class="form-group">
						{!! Form::label('tax_id', __('demand.demand_tax') . ':') !!}
				...
				<tr>
					<td>
						<div class="form-group">
						{!! Form::label('shipping_details', __( 'demand.shipping_details' ) . ':') !!}
					...
					<td>
						<div class="form-group">
						{!! Form::label('shipping_charges','(+) ' . __( 'demand.additional_shipping_charges' ) . ':') !!}
				...
				<tr>
					...
					<td>
						...
						<b>@lang('demand.demand_total'): </b><span id="grand_total" class="display_currency" data-currency_symbol='true'>0</span>
					</td>
				</tr>
				<tr>
					<td colspan="4">
						<div class="form-group">
							{!! Form::label('additional_notes',__('demand.additional_notes')) !!}
	...
	@component('components.widget', ['class' => 'box-primary', 'title' => __('demand.add_payment')])
		<div class="box-body payment_row">
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="pull-right"><strong>@lang('demand.payment_due'):</strong> <span id="payment_due">0.00</span></div>
				</div>
			</div>
			<br>
			<div class="row">
				<div class="col-sm-12">
					<button type="button" id="submit_demand_form" class="btn btn-primary pull-right btn-flat">@lang('messages.save')</button>
				</div>
			</div>
		</div>
	@endcomponent
...
@section('javascript')
	...
	<script type="text/javascript">
		$(document).ready( function(){
      		__page_leave_confirmation('#add_demand_form');
