...
<div class="table-responsive">
    ...
    id="demand_entry_table">
        <thead>
              <tr>
                <th>#</th>
                <th>@lang( 'product.product_name' )</th>
                <th>@if(empty($is_purchase_order)) @lang( 'demand.demand_quantity' ) @else @lang( 'lang_v1.order_quantity' ) @endif</th>
        ...
        <tr @if(!empty($purchase_line->purchase_order_line) && !empty($common_settings['enable_purchase_order'])) data-purchase_order_id="{{$purchase_line->purchase_order_line->transaction_id}}" @endif>
            ...
            <td>
                ...
                @php
                    ...
                    if(!empty($purchase_line->purchase_order_line_id) && !empty($common_settings['enable_purchase_order'])){
                        $max_quantity = $purchase_line->purchase_order_line->quantity - $purchase_line->purchase_order_line->po_quantity_demanded + $purchase_line->quantity;
                    }
                @endphp
