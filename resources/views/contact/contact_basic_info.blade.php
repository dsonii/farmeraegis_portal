...
@endif
<strong><i class="fa fa-money-bill-alt margin-r-5"></i> Promotional Wallet</strong>
<p class="text-muted">
    Rs. {{ $promotional_total }}
</p>
<strong><i class="fa fa-money-bill-alt margin-r-5"></i> Transactional Wallet</strong>
<p class="text-muted">
    Rs. {{ $transactional_total }}
</p>