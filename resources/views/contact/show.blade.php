            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs nav-justified">
                    ...
                    <li class="
                        ...
                        <li class="
                        @if(!empty($view_type) &&  $view_type == 'wallets')
                            active
                        @else
                            ''
                        @endif">
                        <a href="#wallets_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-pen-square" aria-hidden="true"></i> Wallet</a>
                        </li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane"
                        id="wallets_tab">
                        @include('contact.partials.wallets')
                    </div>
