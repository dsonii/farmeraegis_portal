@extends('layouts.app')
@section('title', __('assignment.assign_raw_materials'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header no-print">
    <h1>@lang('assignment.assign_raw_materials')
        <small></small>
    </h1>
    <!-- <ol class="breadcrumb">
...
<section class="content no-print">
    @component('components.filters', ['title' => __('report.filters')])
        <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('purchase_list_filter_location_id',  __('assignment.business_location') . ':') !!}
        ...
        <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('purchase_list_filter_supplier_id',  __('assignment.supplier') . ':') !!}
        ...
        <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('purchase_list_filter_status',  __('assignment.assignment_status') . ':') !!}
    ...
    @component('components.widget', ['class' => 'box-primary', 'title' => __('assignment.all_assign_raw_materials')])
        @include('assign_raw_material.partials.assign_table')
    @endcomponent
