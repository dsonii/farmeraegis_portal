@extends('layouts.app')
@section('title', __('lang_v1.add_demand_order'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>@lang('lang_v1.add_demand_order') <i class="fa fa-keyboard-o hover-q text-muted" aria-hidden="true" data-container="body" data-toggle="popover" data-placement="bottom" data-content="@include('demand.partials.keyboard_shortcuts_details')" data-html="true" data-trigger="hover" data-original-title="" title=""></i></h1>
</section>
...
<section class="content">
	...
	{!! Form::open(['url' => action('DemandOrderController@store'), 'method' => 'post', 'id' => 'add_demand_form', 'files' => true ]) !!}
	@component('components.widget', ['class' => 'box-solid'])
		<input type="hidden" id="is_demand_order">
		<div class="row">
			<!--<div class="@if(!empty($default_purchase_status)) col-sm-4 @else col-sm-3 @endif">
				<div class="form-group">
					...
					<div class="input-group">
						...
						{!! Form::select('contact_id', $suppliers, $supplier_id, ['class' => 'form-control', 'placeholder' => __('messages.please_select'), 'required', 'id' => 'supplier_id']); !!}
			...
			<div class="col-sm-3 @if(!$currency_details->demand_in_diff_currency) hide @endif">
				<div class="form-group">
					...
					<span class="help-block text-danger">
						@lang('demand.diff_purchase_currency_help', ['currency' => $currency_details->name])
					</span>
				</div>
			</div>
					...
					<table class="table table-condensed table-bordered table-th-green text-center table-striped" id="demand_entry_table">
						<thead>
							<tr>
								...
								<th class="{{$hide_field}}">@lang( 'demand.line_total' )</th>
		...
		<div class="row">
			...
			<table class="table">
				...
				<tr class="hide">
					<td>
						<div class="form-group">
						{!! Form::label('tax_id', __('demand.purchase_tax') . ':') !!}
...
@section('javascript')
	...
	<script type="text/javascript">
		$(document).ready( function(){
      		__page_leave_confirmation('#add_demandform');
