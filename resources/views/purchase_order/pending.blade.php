...
<section class="content no-print">
    ...
    @component('components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.all_purchase_orders')])
        ...
        <table class="table table-bordered table-striped ajax_view" id="pending_purchase_order_table" style="width: 100%;">
            <thead>
                <tr>
...
<script type="text/javascript">
    $(document).ready( function(){
        //Purchase table
        purchase_order_table = $('#pending_purchase_order_table').DataTable({
            processing: true,
            serverSide: true,
            aaSorting: [[1, 'desc']],
            scrollY: "75vh",
            ...
            scrollCollapse: true,
            ajax: {
                url: '{{action("PurchaseOrderController@pending")}}',
                data: function(d) {
