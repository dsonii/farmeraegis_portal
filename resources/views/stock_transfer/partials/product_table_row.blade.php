<tr class="product_row">
    ...
    <td><input type="text" name="products[{{$row_index}}][demand_qty]" class="form-control product_demand_qty input_number prod-{{$row_index}}" value="{{@num_format($product->demand_qty)}}"></td>
    ...
    <td><input type="text" readonly name="products[{{$row_index}}][remaining_qty]" class="form-control product_remaining_qty input_number prod_remaining-{{$row_index}}" value="{{@num_format($product->remaining_qty)}}"></td>
