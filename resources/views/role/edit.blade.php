    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-md-8">
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'product.stock_demand', in_array('product.stock_demand', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'product.stock_in_transit', in_array('product.stock_in_transit', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'product.stock_completed', in_array('product.stock_completed', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'product.quantity_finder', in_array('product.quantity_finder', $role_permissions), 
        ...
        <div class="col-md-8">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'assign_raw_materials.view', in_array('assign_raw_materials.view', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'assign_raw_materials.create', in_array('assign_raw_materials.create', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'assign_raw_materials.update', in_array('assign_raw_materials.update', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'assign_raw_materials.delete', in_array('assign_raw_materials.delete', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'assign_raw_materials.update_status', in_array('assign_raw_materials.update_status', $role_permissions),['class' => 'input-icheck']); !!}
                {{ __('lang_v1.update_status') }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'view_own_assign_raw_materials', in_array('view_own_assign_raw_materials', $role_permissions),['class' => 'input-icheck']); !!}
        ...
        <div class="col-md-8">
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'demand.view', in_array('demand.view', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'demand.create', in_array('demand.create', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'demand.update', in_array('demand.update', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'demand.delete', in_array('demand.delete', $role_permissions), 
          ...
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'demand.update_status', in_array('demand.update_status', $role_permissions),['class' => 'input-icheck']); !!}
                {{ __('lang_v1.update_status') }}
              </label>
            </div>
          </div>
          <div class="col-md-12">
            <div class="checkbox">
              <label>
                {!! Form::checkbox('permissions[]', 'view_own_demand', in_array('view_own_demand', $role_permissions),['class' => 'input-icheck']); !!}
          ...
          <div class="row check_group">
            ...
            <div class="col-md-8">
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'demand_order.view_own', in_array('demand_order.view_own', $role_permissions), 
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'demand_order.view_all', in_array('demand_order.view_all', $role_permissions), 
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'demand_order.create', in_array('demand_order.create', $role_permissions), 
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'demand_order.update', in_array('demand_order.update', $role_permissions), 
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                    {!! Form::checkbox('permissions[]', 'demand_order.delete', in_array('demand_order.delete', $role_permissions), 
          ...
          <div class="row check_group">
            ...
            <div class="col-md-8">
              ...
              <div class="col-md-12">
                <div class="checkbox">
                  <label>
                  {!! Form::checkbox('permissions[]', 'purchase_order.quality', in_array('purchase_order.quality', $role_permissions), 
