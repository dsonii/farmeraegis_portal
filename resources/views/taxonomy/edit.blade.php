<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    {!! Form::open(['url' => action('TaxonomyController@update', [$category->id]), 'method' => 'POST', 'id' => 'category_edit_form', "enctype" => "multipart/form-data", 'files' => true ]) !!}
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        {!! Form::label('photo', __( 'lang_v1.photo' ) . ':') !!}
        {!! Form::file('photo', ['id' => 'upload_image', 'accept' => 'image/*']); !!}
      </div>
      <div class="form-group">
        {!! Form::label('icon', __( 'lang_v1.icon' ) . ':') !!}
        {!! Form::file('icon', ['id' => 'upload_icon', 'accept' => 'image/*']); !!}
      </div>
      <div class="form-group">
        {!! Form::label('status', __( 'lang_v1.status' ) . ':') !!}
        {!! Form::select('status', ['0' => 'In-Active', '1' => 'Active'], $category->status, ['class' => 'form-control']); !!}
      </div>
