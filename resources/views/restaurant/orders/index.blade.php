            ...
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        {!! Form::select('service_staff', $service_staff, $s_staff, ['class' => 'form-control select2', 'placeholder' => __('restaurant.select_service_staff'), 'id' => 'service_staff_id']); !!}
                    </div>
                </div>
                {!! Form::close() !!}
            </div>
            ...
            $(document).on('click', '.btn-order-update', function(e){
                ...
                buttons: true,
                    ...
                    if (willDelete) {
                        ...
                        var frm = $('#frm_update_pack_status');
                        $.ajax({
                            method: "POST",
                            url: href,
                            data : frm.serialize(),
                            ...
                            success: function(result){
                                if(result.success == true){
                                    refresh_orders();
                                    toastr.success('Marked as packed.');
                                } else {
