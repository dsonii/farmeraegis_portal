  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            {!! Form::label('invoice_scheme_id', __('business.business_location_type') . ':*') !!}
              {!! Form::select('business_location_type_id', $types, $location->business_location_type_id, ['class' => 'form-control', 'required',
        ...
        <div class="col-sm-6">
          <div class="form-group">
            {!! Form::label('supplier_id', __('business.supplier') . ':*') !!}
              {!! Form::select('supplier_id', $contacts, $location->supplier_id, ['class' => 'form-control', null,
              'placeholder' => __('messages.please_select')]); !!}
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            {!! Form::label('is_supplier', __('business.supplier.is') . ':*') !!}
              {!! Form::select('is_supplier', $contacts, $location->is_supplier, ['class' => 'form-control', null,
              'placeholder' => __('messages.please_select')]); !!}
          </div>
        </div>
        <div class="clearfix"></div>
