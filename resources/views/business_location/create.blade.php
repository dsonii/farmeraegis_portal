  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            {!! Form::label('business_location_type_id', __('business.business_location_type') . ':*') !!}
              {!! Form::select('business_location_type_id', $types, null, ['class' => 'form-control', 'required',
        ...
        <div class="col-sm-6">
          <div class="form-group">
            {!! Form::label('supplier_id', __('business.supplier') . ':*') !!}
              {!! Form::select('supplier_id', $contacts, null, ['class' => 'form-control', null,
              'placeholder' => __('messages.please_select')]); !!}
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            {!! Form::label('supplier_create', __('business.supplier.create') . ':*') !!}
            <br />
            {!! Form::checkbox('supplier_create', 'Y', false); !!}
          </div>
        </div>
        <div class="clearfix"></div>
        <div class="col-sm-6">
