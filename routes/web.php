...
Route::get('wallets-sync-from-api', 'API\SYNC\WalletController@sync')->name('wallets-sync-from-api');
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::post('/taxonomies/{id}', 'TaxonomyController@update');
    ...
    Route::get('get-commision-agent/{contact_id}', 'SalesCommissionAgentController@getCommisionAgentDetails');
    ...
    Route::resource('warehouse-quantity-save', 'WarehouseQuantityController@warehouseQty');
    ...
    Route::post('/demand-return/update', 'CombinedDemandReturnController@update');
    Route::get('/demand-return/edit/{id}', 'CombinedDemandReturnController@edit');
    Route::post('/demand-return/save', 'CombinedDemandReturnController@save');
    Route::post('/demand-return/get_product_row', 'CombinedDemandReturnController@getProductRow');
    Route::get('/demand-return/create', 'CombinedDemandReturnController@create');
    Route::get('/demand-return/add/{id}', 'DemandReturnController@add');
    Route::resource('/demand-return', 'DemandReturnController', ['except' => ['create']]);
    Route::get('/demand-qty-finder', 'DemandController@demandQtyFinder');
    Route::get('get-demand-orders-qty-finder/{contact_id}', 'DemandController@getDemandOrdersForQtyFinder');
    ...
    Route::group(['prefix' => 'modules'], function () {
        ...
        Route::post('/orders/mark-as-served/{id}', 'Restaurant\OrderController@markAsServed');
    ...
    // pending
    Route::get('pending-purchase-order', 'PurchaseOrderController@pending');
    Route::get('pending-demands', 'DemandController@pending');
    Route::get('pending-sales', 'SellController@pending');

    // completed
    Route::get('completed-purchase-order', 'PurchaseOrderController@completed');
    Route::get('completed-demands', 'DemandController@completed');
    Route::get('completed-sales', 'SellController@completed');
    ...
    Route::get('get-purchase-orders-po', 'PurchaseOrderController@getPurchaseOrdersPo');
    ...
    Route::resource('assign-raw-material', 'AssignRawMaterialController');

    Route::resource('demand-order', 'DemandOrderController');
    Route::get('get-demand-orders/{contact_id}', 'DemandOrderController@getDemandOrders');
    Route::get('get-demand-order-lines/{demand_order_id}', 'DemandController@getDemandOrderLines');
    Route::get('get-demand-order-lines-product/{demand_order_id}', 'DemandController@getDemandOrderLinesProducts');
    Route::get('edit-demand-orders/{id}/status', 'DemandOrderController@getEditPurchaseOrderStatus');
    Route::put('update-demand-orders/{id}/status', 'DemandOrderController@postEditPurchaseOrderStatus');

    Route::get('get-location-details/{location_id}', 'DemandOrderController@getLocationDetails');
    
    Route::post('/demands/update-status', 'DemandController@updateStatus');
    Route::get('/demands/get_products', 'DemandController@getProducts');
    Route::get('/demand/get_products', 'DemandController@getProducts');
    Route::get('/demands/get_suppliers', 'DemandController@getSuppliers');
    Route::post('/demands/get_demand_entry_row', 'DemandController@getDemandEntryRow');
    Route::post('/demands/check_ref_number', 'DemandController@checkRefNumber');
    Route::resource('demands', 'DemandController')->except(['show']);
    Route::get('/demands/{id}', 'DemandController@show');
    Route::get('/demands/print/{id}', 'DemandController@printInvoice');
});
