...
[Get Postman Collection](http://localhost/farmer4.0/public/docs/collection.json)
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "http://localhost/farmer4.0/public/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"voluptate","ip_address":"beatae","latitude":"mollitia","longitude":"nobis"}'
...
```bash
curl -X POST \
    "http://localhost/farmer4.0/public/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"eum","latitude":"quaerat","longitude":"cumque"}'
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/holidays?location_id=modi&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/holidays"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=enim&follow_up_type=praesentium&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/crm/follow-ups"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X PUT \
    "http://localhost/farmer4.0/public/connector/api/crm/follow-ups/20" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"deleniti","schedule_type":"quia","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","followup_additional_info":"['call duration' => '1 hour']","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","allow_notification":true}'
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=voluptatem&biz_name=deserunt&mobile_num=15&contact_id=et&order_by=minus&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/crm/leads"
);
...
```bash
curl -X POST \
    "http://localhost/farmer4.0/public/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"necessitatibus","mobile_name":"libero","call_type":"call","start_time":"et","end_time":"qui","duration":"nam"}]}'
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=delectus&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":16,"initial_amount":180999811.91,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":7600737.94,"total_card_slips":16,"total_cheques":14,"closing_note":"delectus","transaction_ids":"1,2,3"}'
...
let body = {
    "location_id": 16,
    "initial_amount": 180999811.91,
    "created_at": "2020-5-7 15:20:22",
    "closed_at": "2020-5-7 15:20:22",
    "status": "close",
    "closing_amount": 7600737.94,
    "total_card_slips": 16,
    "total_cheques": 14,
    "closing_note": "delectus",
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/contactapi?type=sunt&name=ut&biz_name=modi&mobile_num=18&contact_id=eius&order_by=voluptatum&direction=eligendi&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"non","prefix":"fugit","first_name":"enim","middle_name":"ut","last_name":"nihil","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"autem","address_line_2":"repudiandae","city":"fugiat","state":"quidem","country":"consequuntur","zip_code":"dolore","customer_group_id":"earum","contact_id":"sint","dob":"2000-06-13","custom_field1":"nulla","custom_field2":"quis","custom_field3":"maxime","custom_field4":"nesciunt","email":"aut","shipping_address":"eveniet","position":"et","opening_balance":0,"source_id":2,"life_stage_id":15,"assigned_to":[]}'
...
let body = {
    ...
    "zip_code": "dolore",
    "customer_group_id": "earum",
    "contact_id": "sint",
    "dob": "2000-06-13",
    "custom_field1": "nulla",
    "custom_field2": "quis",
    "custom_field3": "maxime",
    "custom_field4": "nesciunt",
    "email": "aut",
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"et","prefix":"minima","first_name":"distinctio","middle_name":"voluptas","last_name":"unde","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"molestias","address_line_2":"adipisci","city":"qui","state":"quis","country":"aut","zip_code":"accusamus","customer_group_id":"excepturi","contact_id":"similique","dob":"2000-06-13","custom_field1":"perspiciatis","custom_field2":"aspernatur","custom_field3":"quae","custom_field4":"nesciunt","email":"explicabo","shipping_address":"animi","position":"hic","opening_balance":10.3,"source_id":8,"life_stage_id":19,"assigned_to":[]}'
...
```bash
curl -X POST \
    "http://localhost/farmer4.0/public/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":14,"card_number":"nam","card_holder_name":"est","card_transaction_number":"sunt","card_type":"qui","card_month":"voluptatem","card_year":"est","card_security":"commodi","transaction_no_1":"illum","transaction_no_2":"aliquid","transaction_no_3":"pariatur","cheque_number":"quia","bank_account_number":"nihil","note":"quia"}'
...
let body = {
    ...
    "card_year": "est",
    "card_security": "commodi",
    "transaction_no_1": "illum",
    "transaction_no_2": "aliquid",
    "transaction_no_3": "pariatur",
    "cheque_number": "quia",
    "bank_account_number": "nihil",
    "note": "quia"
}
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/expense?location_id=aliquam&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=sed&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/expense"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":12,"final_total":116.86,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":7,"expense_for":13,"contact_id":9,"additional_notes":"fuga","is_refund":0,"is_recurring":0,"recur_interval":3,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"pariatur","recur_repetitions":12,"payment":[{"amount":453.13,"method":"cash","account_id":2,"card_number":"iure","card_holder_name":"velit","card_transaction_number":"vel","card_type":"enim","card_month":"libero","card_year":"et","card_security":"dolor","transaction_no_1":"qui","transaction_no_2":"quam","transaction_no_3":"asperiores","note":"ut","cheque_number":"qui"}]}'
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "http://localhost/farmer4.0/public/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":7.6974,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":20,"expense_for":18,"contact_id":5,"additional_notes":"beatae","is_recurring":0,"recur_interval":11,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"dolores","recur_repetitions":20,"payment":[]}'
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/expense-refund?location_id=aut&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=nam&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/expense-refund"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/product?brand_id=et&category_id=corporis&sub_category_id=ex&location_id=dolores&selling_price_group=ut&name=officia&sku=dolores&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/product"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/product/1?selling_price_group=ea" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/product/1"
);

let params = {
    "selling_price_group": "ea",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/variation/?brand_id=et&category_id=pariatur&sub_category_id=consequuntur&not_for_selling=at&name=voluptatum&sku=consequatur&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/variation/"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/sell?location_id=doloribus&contact_id=distinctio&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&user_id=possimus&service_staff_id=eveniet&shipping_status=ordered&only_subscriptions=et&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/sell"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":18,"contact_id":6,"transaction_date":"2020-07-22 15:48:29","invoice_no":"sunt","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":3,"discount_amount":10,"discount_type":"fixed","sale_note":"eos","staff_note":"sint","commission_agent":16,"shipping_details":"Express Delivery","shipping_address":"placeat","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":4,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":3,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"autem","recur_repetitions":4,"rp_redeemed":19,"rp_redeemed_amount":13.5,"types_of_service_id":8,"service_custom_field_1":"unde","service_custom_field_2":"esse","service_custom_field_3":"et","service_custom_field_4":"tenetur","round_off_amount":77.0153716,"table_id":4,"service_staff_id":19,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":6,"note":"cum"}],"payments":[{"amount":453.13,"method":"cash","account_id":17,"card_number":"dolorum","card_holder_name":"repellendus","card_transaction_number":"atque","card_type":"animi","card_month":"ipsam","card_year":"explicabo","card_security":"quisquam","transaction_no_1":"deserunt","transaction_no_2":"qui","transaction_no_3":"aut","bank_account_number":"et","note":"commodi","cheque_number":"ducimus"}]}]}'
    ...
    "sells": [
        {
            ...
            "recur_interval_type": "months",
            "subscription_repeat_on": 15,
            "subscription_no": "autem",
            "recur_repetitions": 4,
            "rp_redeemed": 19,
            "rp_redeemed_amount": 13.5,
            "types_of_service_id": 8,
            "service_custom_field_1": "unde",
            "service_custom_field_2": "esse",
            "service_custom_field_3": "et",
            "service_custom_field_4": "tenetur",
            "round_off_amount": 77.0153716,
            "table_id": 4,
            "service_staff_id": 19,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "card_month": "ipsam",
                    "card_year": "explicabo",
                    "card_security": "quisquam",
                    "transaction_no_1": "deserunt",
                    "transaction_no_2": "qui",
                    "transaction_no_3": "aut",
                    "bank_account_number": "et",
                    "note": "commodi",
                    "cheque_number": "ducimus"
                }
            ]
        }
    ]
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/sell/55" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/sell/55"
);
...
```bash
curl -X PUT \
    "http://localhost/farmer4.0/public/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":12,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":10,"discount_amount":10,"discount_type":"fixed","sale_note":"aliquam","staff_note":"magnam","sells":[{"is_suspend":false}],"commission_agent":14,"shipping_details":"Express Delivery","shipping_address":"laborum","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":14,"pay_term_number":18,"pay_term_type":"months","is_recurring":0,"recur_interval":6,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"aut","recur_repetitions":7,"rp_redeemed":11,"rp_redeemed_amount":13.5,"types_of_service_id":8,"service_custom_field_1":"explicabo","service_custom_field_2":"voluptas","service_custom_field_3":"doloremque","service_custom_field_4":"sunt","round_off_amount":175.3,"table_id":17,"service_staff_id":2,"change_return":0,"change_return_id":9,"products":[{"sell_line_id":5,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":7,"discount_amount":0,"discount_type":"percentage","sub_unit_id":4,"note":"voluptatem"}],"payments":[{"payment_id":11,"amount":453.13,"method":"cash","account_id":19,"card_number":"nihil","card_holder_name":"omnis","card_transaction_number":"assumenda","card_type":"fugit","card_month":"quod","card_year":"aut","card_security":"ut","transaction_no_1":"qui","transaction_no_2":"id","transaction_no_3":"voluptatem","note":"minima","cheque_number":"quia","bank_account_number":"temporibus"}]}'
    ...
    "payments": [
        {
            ...
            "card_transaction_number": "assumenda",
            "card_type": "fugit",
            "card_month": "quod",
            "card_year": "aut",
            "card_security": "ut",
            ...
            "note": "minima",
            "cheque_number": "quia",
            "bank_account_number": "temporibus"
        }
    ]
}
...
```bash
curl -X DELETE \
    "http://localhost/farmer4.0/public/connector/api/sell/qui" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "http://localhost/farmer4.0/public/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":10,"transaction_date":"2020-5-7 15:20:22","invoice_no":"eum","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":9,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "http://localhost/farmer4.0/public/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":6,"shipping_status":"ordered","delivered_to":"et"}'
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/table?location_id=non" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/table"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/taxonomy?type=ratione" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/user/loggedin"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/user?service_staff=sed" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/user"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/user/1"
);
...
```bash
curl -X POST \
    "http://localhost/farmer4.0/public/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"qui","new_password":"inventore"}'
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/profit-loss-report?location_id=sit&start_date=2018-06-25&end_date=2018-06-25&user_id=sint" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/profit-loss-report"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "http://localhost/farmer4.0/public/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/farmer4.0/public/connector/api/notifications"
);
